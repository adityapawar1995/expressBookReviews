...
public_users.get('/',function (req, res) {
  // Return the list of all books using async-await with Axios
  (async () => {
    try {
      // Simulate fetching books from an API endpoint (here, local file)
...
public_users.get('/author/:author',function (req, res) {
  // Get all books by the specified author using async-await with Axios
...
public_users.get('/title/:title',function (req, res) {
  // Get all books by the specified title
